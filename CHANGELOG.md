...
## [0.19.3] Q1 2024
- update default credentials for keycloak backend authentication

## [0.19.2] Q1 2024
- fixed copying of sparse files (wic images)

## [0.19.1] Q1 2024
- fixed wrong user consent criteria while generating importManifest.json
- fixed camel case in struct

## [0.19.0] Q1 2024
- integrated device-update-importer functionality

## [0.18.3] Q1 2024
- fixed decompressed image filename

## [0.18.2] Q1 2024
- fixed integration test

## [0.18.1] Q1 2024
- updated zerocopy to 0.7.32
- updated zerocopy-derive to 0.7.32
- fixed build warning about unused features
